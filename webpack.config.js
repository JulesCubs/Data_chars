const path = require('path'); //Permite acceder el lugar o la ubicación lógica de donde nos encontramos en el proyecto
const HtmlWebpackPlugin = require('html-webpack-plugin'); //Permite el archivo necesario para trabajar con html
//const { rejects } = require('assert');
const CopyWebpackPlugin = require('copy-webpack-plugin');

//modulo donde esta la configuración de las acciones a realizar
